...
type Props = {};
import Routines from "@/components/flaskcomponents/Routines";
import Exercises from "@/components/flaskcomponents/Exercises";
import { useSidebarStore } from "@/utils/zustand/sidebar.store";
import { useAuthStore } from "@/utils/zustand/auth.store";
import { useRouter } from "next/navigation";
import Meals from "@/components/flaskcomponents/Meals";
import Foods from "@/components/flaskcomponents/Foods";
import Calendar from "@/components/flaskcomponents/Calendar";
      ...
      <div className="flex min-h-screen flex-col justify-center p-24  w-full bg-black text-white">
        <div>
          <p className="text-center">
            {`Welcomee ${auth.username}. This is your dashboard`}!
          </p>
