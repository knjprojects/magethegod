...
>*/}
      {isVisible ? (
        <div>
          <h1>
            Assign Meals and Routine for this day. You have to create routines
            and meals before you add it to a clendar date
          </h1>
          <p>Choose date, datepicker here</p>
              ...
              <div className="flex flex-row w-full gap-3 items-center">
                <div>
                  ...
                  {routines ? (
                    <select
                      ...
                      onChange={(e: any) => handleSelectRoutine(e.target.value)}
                    >
                ...
                <div>
                  {meals ? (
                    <select
                      className="text-black"
                      onChange={(e: any) => handleSelectMeal(e.target.value)}
                    >
                      {meals.map((meal: any) => (
